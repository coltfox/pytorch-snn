...
class RateEncoder(SpikingLayer):
    ...
    def __init__(self, n_neurons: int, batch_size: int = 500, v_thr: float = 1.0, device: torch.device | str = 'cpu', gain: float = 1.0, bias: float = 1.0) -> None:
        """
        Args:
            ...
            bias (float): Neuron bias. Default 1.0
        """
